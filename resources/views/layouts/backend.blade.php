...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header is-small-screen">
    ...
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            <a class="mdl-navigation__link" href="{{url('home/form')}}">
...
<script src="{{asset('js/material-design-lite/material.min.js')}}"></script>
<script src="{{asset('js/mdl/d3.js')}}"></script>
<script src="{{asset('js/mdl/getmdl-select.min.js')}}"></script>
{{--<script src="js/mdl/material.js"></script>--}}
<script src="{{asset('js/mdl/nv.d3.js')}}"></script>
<script src="{{asset('js/mdl/widgets/employer-form/employer-form.js')}}"></script>
<script src="{{asset('js/mdl/widgets/line-chart/line-chart-nvd3.js')}}"></script>
<script src="{{asset('js/mdl/widgets/pie-chart/pie-chart-nvd3.js')}}"></script>
<script src="{{asset('js/mdl/widgets/table/table.js')}}"></script>
<script src="{{asset('js/mdl/widgets/todo/todo.js')}}"></script>
